...
export const copy: Record<'en' | 'ml', CopyType> = {
  en: {
    ...
    email: 'contact@thanal.org', phone: '+91 94955 75716', address: 'Thanal Charitable Society, Kommady, Alappuzha, Kerala 688007',
  ...
  ml: {
    ...
    aboutLabel: '01 / കൂട്ടായ്മ', aboutTitle: 'കരുതലിൽ വേരൂന്നി.\nമാറ്റത്തിനായി പണിതത്.', aboutBody: '1955-ലെ തിരുവിതാംകൂർ കൊച്ചി സാഹിത്യ ശാസ്ത്രീയ ധർമ്മസംഘങ്ങളുടെ രജിസ്ട്രേഷൻ ആക്ട് പ്രകാരം 2004-ൽ സ്ഥാപിതമായ തണൽ (THANAL), കൊമ്മാടി വാർഡിലും ആര്യാട് പഞ്ചായത്തിലെ 2 വാർഡുകളും ആലപ്പുഴ നഗരസഭയിലെ ബാക്കി വാർഡുകളും ഉൾപ്പെടെ 7 അയൽ വാർഡുകളിലും സാമൂഹിക സേവനം നടത്തിവരുന്നു.', history: 'വളരുന്ന കരുതൽ വലയം', historyBody: 'ആരോഗ്യപരിചരണത്തിലും വിദ്യാഭ്യാസത്തിലും ഞങ്ങൾ ശ്രദ്ധ കേന്ദ്രീകരിക്കുന്നു: ഡോ. കെ. വേണുഗോപാൽ (പൾമണോളജിസ്റ്റ്), ഡോ. വി. ജയറാം (കാർഡിയോളജിസ്റ്റ്) തുടങ്ങിയ പ്രമുഖ ഡോക്ടർമാരുടെ നേതൃത്വത്തിൽ സൂപ്പർ സ്പെഷ്യാലിറ്റി മെഡിക്കൽ ക്യാമ്പുകൾ, ക്യാൻസർ പോലെയുള്ള മാരക രോഗങ്ങൾ അനുഭവിക്കുന്ന നിർധന കുടുംബങ്ങളിലെ രോഗികൾക്ക് സാമ്പത്തിക സഹായം, പാവപ്പെട്ട കുടുംബങ്ങളിലെ വിദ്യാർത്ഥികൾക്ക് വാർഷിക വിദ്യാഭ്യാസ സ്കോളർഷിപ്പുകൾ.',
