...
export const copy: Record<'en' | 'ml', CopyType> = {
  en: {
    ...
    heroEyebrow: 'THANAL Charitable Society, Alappuzha — Rooted in community care since 2004',
    heroTitle: 'Care that reaches people.\nChange that stays.',
    heroBody: 'THANAL Charitable Society, Alappuzha is a registered charitable organisation serving families across Kommady, Alappuzha municipality, and Aryad Panchayat with a focus on health care and education.',
    join: 'Join STEP',
    explore: 'Explore our work',
    aboutLabel: '01 / The collective',
    aboutTitle: 'Rooted in care.\nServing with purpose.',
    aboutBody: 'THANAL Charitable Society, Alappuzha, established in 2004 under the Travancore Cochin Literary, Scientific and Charitable Societies Act 1955, has been earnestly rendering social services in Kommady ward and seven adjacent wards, including two wards in Aryad Panchayat and the remaining wards in Alappuzha municipality.',
    ...
    galleryItems: [
      {
        ...
        image: '/images/health-camp-1.jpg',
        description: 'Super speciality free medical camps featuring eminent doctors such as Dr. K. Venugopal (Pulmonologist) and Dr. V. Jayaram (Cardiologist) offering free consultations, diagnosis, and medicines.',
        photos: [
          {
            id: 101,
            title: 'Free Medicine Pharmacy & Diagnostic Registration Desk',
            image: '/images/health-camp-1.jpg',
            description: 'Medical camp pharmacy counter and volunteer registration desk for free diagnosis, blood testing, and essential medicine distribution.',
          },
          {
            id: 102,
            title: 'Medical Camp Volunteer & Doctor Desk',
            image: '/images/health-camp-2.jpg',
            description: 'Volunteer nurses, doctors, and health professionals attending patients and organizing free diagnostic samples.',
          },
          {
            id: 103,
            title: 'Super Speciality Medical Camp Inauguration & Lamp Lighting',
            image: '/images/health-camp-3.jpg',
            description: 'Solemn inauguration of the THANAL Super Speciality Medical Camp with traditional lamp lighting by dignitaries and guest doctors.',
          },
          {
            id: 104,
            title: 'Lighting of the Ceremonial Lamp',
            image: '/images/health-camp-4.jpg',
            description: 'Distinguished doctors and THANAL office bearers lighting the lamp to commence the free medical camp.',
          },
          {
            id: 105,
            title: 'Medical Camp Inaugural Function & Presidential Address',
            image: '/images/health-camp-5.jpg',
            description: 'Keynote address by dignitaries and medical specialists highlighting health awareness and community wellness.',
          },
          {
            id: 106,
            title: 'Elderly Patient Health Consultation & Care',
            image: '/images/health-camp-6.jpg',
            description: 'Attending elderly citizens and providing personal medical consultations during the free health camp.',
          },
          {
            id: 107,
            title: 'Doctor Prescription & Medical Advice',
            image: '/images/health-camp-7.jpg',
            description: 'Doctor examining patient reports, writing prescriptions, and explaining medicine dosage.',
          },
          {
            id: 108,
            title: 'Specialist Medical Consultation',
            image: '/images/health-camp-8.jpg',
            description: 'Eminent doctor conducting detailed health evaluation and providing free medical counsel to patients.',
          },
          {
            id: 109,
            title: 'Patient Health Checkup with Stethoscope',
            image: '/images/health-camp-9.jpg',
            description: 'Medical specialist checking patient vitals and providing expert clinical recommendations.',
          },
          {
            id: 110,
            title: 'Individual Doctor-Patient Consultation Desk',
            image: '/images/health-camp-10.jpg',
            description: 'Dedicated individual doctor consultation desk ensuring dignified health care access for all.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        photos: [
          ...
          {
            id: 305,
            title: 'Community Care Guest Felicitation & Honor',
            image: '/images/medical-camp-2.jpg',
            description: 'Honoring community contributors and guests at the THANAL collective care gathering.',
          },
        ],
      },
    ],
  ...
  ml: {
    ...
    heroEyebrow: 'THANAL Charitable Society, Alappuzha — 2004 മുതൽ സമൂഹകരുതലിൽ വേരൂന്നിയ സൊസൈറ്റി',
    heroTitle: 'ആളുകളിലേക്ക് എത്തുന്ന കരുതൽ.\nനിലനിൽക്കുന്ന മാറ്റം.',
    heroBody: 'THANAL Charitable Society, Alappuzha (തണൽ ചാരിറ്റബിൾ സൊസൈറ്റി, കൊമ്മാടി) ഒരു രജിസ്റ്റർ ചെയ്ത സന്നദ്ധ സംഘടനയാണ്. ആരോഗ്യപരിചരണത്തിലും വിദ്യാഭ്യാസത്തിലും ശ്രദ്ധ കേന്ദ്രീകരിച്ച് കൊമ്മാടി, ആലപ്പുഴ നഗരസഭ, ആര്യാട് പഞ്ചായത്തിലെ കുടുംബങ്ങളോടൊപ്പം ഞങ്ങൾ പ്രവർത്തിക്കുന്നു.',
    join: 'STEP-ൽ ചേരുക', explore: 'ഞങ്ങളുടെ പ്രവർത്തനങ്ങൾ കാണുക',
    aboutLabel: '01 / കൂട്ടായ്മ', aboutTitle: 'കരുതലിൽ വേരൂന്നി.\nമാറ്റത്തിനായി പണിതത്.', aboutBody: '1955-ലെ തിരുവിതാംകൂർ കൊച്ചി സാഹിത്യ ശാസ്ത്രീയ ധർമ്മസംഘങ്ങളുടെ രജിസ്ട്രേഷൻ ആക്ട് പ്രകാരം 2004-ൽ സ്ഥാപിതമായ THANAL Charitable Society, Alappuzha (തണൽ ചാരിറ്റബിൾ സൊസൈറ്റി), കൊമ്മാടി വാർഡിലും ആര്യാട് പഞ്ചായത്തിലെ 2 വാർഡുകളും ആലപ്പുഴ നഗരസഭയിലെ ബാക്കി വാർഡുകളും ഉൾപ്പെടെ 7 അയൽ വാർഡുകളിലും സാമൂഹിക സേവനം നടത്തിവരുന്നു.',
    ...
    galleryItems: [
      {
        ...
        photos: [
          {
            id: 101,
            title: 'സൗജന്യ മരുന്ന് വിതരണവും രജിസ്ട്രേഷൻ കൗണ്ടറും',
            image: '/images/health-camp-1.jpg',
            description: 'സൗജന്യ മെഡിക്കൽ ക്യാമ്പിൽ രോഗികൾക്ക് മരുന്നുകൾ വിതരണം ചെയ്യുന്ന ഫാർമസി കൗണ്ടറും സന്നദ്ധ പ്രവർത്തകരുടെ രജിസ്ട്രേഷൻ കൗണ്ടറും.',
          },
          {
            id: 102,
            title: 'ഡോക്ടർമാരുടെയും സന്നദ്ധപ്രവർത്തകരുടെയും സേവനം',
            image: '/images/health-camp-2.jpg',
            description: 'പരിശോധനകൾക്കും രക്ത സാമ്പിൾ ശേഖരണത്തിനും മരുന്ന് വിതരണത്തിനുമായി തയ്യാറായി നിൽക്കുന്ന മെഡിക്കൽ സംഘം.',
          },
          {
            id: 103,
            title: 'സൗജന്യ മെഡിക്കൽ ക്യാമ്പ് ഉദ്ഘാടന ചടങ്ങ്',
            image: '/images/health-camp-3.jpg',
            description: 'തണൽ ചാരിറ്റബിൾ സൊസൈറ്റി സൗജന്യ മെഡിക്കൽ ക്യാമ്പിന്റെ ഭദ്രദീപം കൊളുത്തിയുള്ള തത്സമയ ഉദ്ഘാടനം.',
          },
          {
            id: 104,
            title: 'മെഡിക്കൽ ക്യാമ്പ് ഭദ്രദീപ പ്രജ്വലനം',
            image: '/images/health-camp-4.jpg',
            description: 'പ്രമുഖ ഡോക്ടർമാരും തണൽ ഭാരവാഹികളും ചേർന്ന് മെഡിക്കൽ ക്യാമ്പ് ഉദ്ഘാടനം ചെയ്യുന്നു.',
          },
          {
            id: 105,
            title: 'മെഡിക്കൽ ക്യാമ്പ് പൊതുസമ്മേളന പ്രസംഗം',
            image: '/images/health-camp-5.jpg',
            description: 'മെഡിക്കൽ ക്യാമ്പ് ഉദ്ഘാടന വേദിയിൽ വിശിഷ്ടാതിഥികളുടെയും ഡോക്ടർമാരുടെയും സന്ദേശം.',
          },
          {
            id: 106,
            title: 'മുതിർന്ന പൗരന്മാർക്കുള്ള വൈദ്യപരിശോധന',
            image: '/images/health-camp-6.jpg',
            description: 'സൗജന്യ മെഡിക്കൽ ക്യാമ്പിൽ മുതിർന്ന പൗരന്മാർക്ക് പ്രത്യേക പരിശോധനയും കൗൺസിലിംഗും നൽകുന്നു.',
          },
          {
            id: 107,
            title: 'ഡോക്ടറുടെ മരുന്ന് കുറിപ്പടിയും പരിശോധനയും',
            image: '/images/health-camp-7.jpg',
            description: 'രോഗികളുടെ ലക്ഷണങ്ങൾ പരിശോധിക്കുകയും നിർദ്ദേശങ്ങൾക്കനുസരിച്ച് സൗജന്യ മരുന്നുകൾ കുറിക്കുകയും ചെയ്യുന്നു.',
          },
          {
            id: 108,
            title: 'വിദഗ്ദ്ധ ഡോക്ടർമാരുടെ പരിശോധന',
            image: '/images/health-camp-8.jpg',
            description: 'പ്രമുഖ ഡോക്ടർമാർ രോഗികളെ നേരിട്ട് പരിശോധിച്ച് തുടർചികിത്സയും ഉപദേശങ്ങളും നൽകുന്നു.',
          },
          {
            id: 109,
            title: 'സ്റ്റെതസ്കോപ്പ് ഉപയോഗിച്ചുള്ള ശാരീരിക പരിശോധന',
            image: '/images/health-camp-9.jpg',
            description: 'രോഗികളുടെ ആരോഗ്യാവസ്ഥ നിർണ്ണയിക്കാനും അടിയന്തര ചികിത്സ നൽകാനുമുള്ള വിദഗ്ദ്ധ പരിശോധന.',
          },
          {
            id: 110,
            title: 'വ്യക്തിഗത ഡോക്ടർ-രോഗി സംഭാഷണ കൗണ്ടർ',
            image: '/images/health-camp-10.jpg',
            description: 'ഓരോ രോഗിക്കും വ്യക്തിഗത ശ്രദ്ധ ഉറപ്പാക്കുന്ന തണൽ മെഡിക്കൽ ക്യാമ്പ് കൗണ്ടർ.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        photos: [
          ...
          {
            id: 305,
            title: 'കൂട്ടായ കരുതൽ അതിഥി ആദരവ്',
            image: '/images/medical-camp-2.jpg',
            description: 'സമൂഹക്ഷേമ രംഗത്തെ സംഭാവനകൾക്ക് അതിഥികളെയും ഉപകാരികളെയും തണൽ സൊസൈറ്റി ആദരിക്കുന്നു.',
          },
        ],
      },
    ],
